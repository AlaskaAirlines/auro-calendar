...
```bash
origin  https://github.com/[yourUserName]/auro-calendar.git (fetch)
origin  https://github.com/[yourUserName]/auro-calendar.git (push)
```

To add the upstream repo to your local forked project

```bash
$ git remote add upstream https://github.com/AlaskaAirlines/auro-calendar.git
```
...
origin  https://github.com/[yourUserName]/auro-calendar.git (fetch)
origin  https://github.com/[yourUserName]/auro-calendar.git (push)
upstream        https://github.com/AlaskaAirlines/auro-calendar.git (fetch)
upstream        https://github.com/AlaskaAirlines/auro-calendar.git (push)
```
